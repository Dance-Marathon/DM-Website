...
<div class="page-content">
	<div class="container">
      ...
      <?php if ($status == "open") { ?>
				...
				<h2>DonorDrive FAQ: Internal DonorDrive Teams</h2>
				<p></p>
...
<ul><li>Ambassadors that also have Captain positions will be registered on DonorDrive with their Organization and not their Captain Team.</li></ul>
...
<ul><li>The Miracle Cup winner will be calculated based on Organization fundraising. We want to help celebrate the efforts of the 825 dancer participants' fundraising efforts in each of the organizations. As such, Captain/Emerging Leader fundraising will be counted separately on their own DonorDrive teams.</li>
...
<ul><li>Now, it’s as easy as checking DonorDrive! As an Ambassador, you can simply visit your team’s fundraising page and view your total thermometer. From there, you can visit other team pages and view their total thermometer. DonorDrive is updated in real-time so you can constantly stay updated on where every Organization stands in relation to another.</li>
