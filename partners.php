      ...
      <?php if ($status == "open") { ?>
          ...
          <div class="panel panel-default">
            <div class="panel-heading" role="tab" id="q2">
              <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#a2" aria-expanded="false" aria-controls="a2">Champion Level</a>
              </h4>
            </div>
          ...
          <div class="panel panel-default">
            <div class="panel-heading" role="tab" id="q4">
              <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#a4" aria-expanded="false" aria-controls="a4">Marathon Level</a>
              </h4>
            </div>
          ...
          <div class="panel panel-default">
            <div class="panel-heading" role="tab" id="q5">
              <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#a5" aria-expanded="false" aria-controls="a5">Gator Level</a>
              </h4>
            </div>
          ...
          <div class="panel panel-default">
            <div class="panel-heading" role="tab" id="q6">
              <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#a6" aria-expanded="false" aria-controls="a6">Blue Level</a>
              </h4>
            </div>
          ...
          <div class="panel panel-default">
            <div class="panel-heading" role="tab" id="q7">
              <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#a7" aria-expanded="false" aria-controls="a7">Orange Level</a>
              </h4>
            </div>
          ...
          <div class="panel panel-default">
            <div class="panel-heading" role="tab" id="q8">
              <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#a8" aria-expanded="false" aria-controls="a8">Spirit Level</a>
              </h4>
            </div>
            <div id="a8" class="panel-collapse collapse" role="tabpanel" aria-labelledby="q8">
              <div class="panel-body">
                <table width="100%">
              		<tr>
                		<td valign="top"><a href="https://www.facebook.com/charliessnowshack?rf=221989831248290" target="_blank">Charlie's Snow Shack</a><br/><a href="http://www.keurig.com/" target="_blank">Keurig</a><br/><a href="http://shcc.ufl.edu/" target="_blank">UF Student Health Care Center</a><br/><a href="http://www.smokinnotes.com/" target="_blank">Smokin' Notes</a><br/><a href="http://www.sg.ufl.edu/" target="_blank">UF Student Government</a><br/><a href="http://www.recsports.ufl.edu/" target="_blank">Rec Sports</a><br/></td>
                        <td valign="top"><a href="http://www.gatordlites.com/" target="_blank">D'lites Emporium</a><br/><a href="http://newscooters4less.com/" target="_blank">New Scooters 4 Less</a><br/><a href="http://www.fit2run.com/" target="_blank">Fit 2 Run (FT5K Sponsor)</a><br/><a href="http://www.guyharveyshirts.com/?gclid=CJbTgJ-zhsQCFQsxaQod6H0ABg" target="_blank">Guy Harvey</a><br/><a href="http://www.simplygorgeousgifts.com/" target="_blank">Simply Gorgeous</a><br/><a href="http://www.cottagegroveatgainesville.com/" target="_blank">Cottage Grove Apartments</a><br/></td>
                	</tr>
                </table>
              </div>
            </div>
          ...
          <div class="panel panel-default">
            <div class="panel-heading" role="tab" id="q9">
              <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#a9" aria-expanded="false" aria-controls="a9">Friendship Level</a>
              </h4>
            </div>
            <div id="a9" class="panel-collapse collapse" role="tabpanel" aria-labelledby="q9">
              ...
              <table width="100%">
              	<tr>
                	<td valign="top">Target Copy<br/>Renaissance Printing<br/>Copper Monkey<br/>Study Edge<br/>Zoe's<br/>Smokin' Notes<br/>Amazon Student<br/>TGI Fridays<br/>Alumni Hall<br/>Trader Joes<br/>Tire Kingdom<br/>Aqua Tropics<br/>Applebee's<br/>Big Lou's<br/>Red Bull<br/></td>
