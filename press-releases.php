...
<div class="page-content">
	<div class="container">
      ...
      <?php if ($status == "open") { ?>
        ...
        <p>If you have any questions, please contact Megan Freedman, Public Relations Overall at <a href="mailto:Crollosson@floridadm.org">Crollosson@floridadm.org</a>.</p>
