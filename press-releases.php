...
<div class="page-content">
	<div class="container">
      ...
      <?php if ($status == "open") { ?>
        ...
        <p>If you have any questions, please contact Megan Freedman, Public Relations Overall Director, at <a href="mailto:mfreedman@floridadm.org">mfreedman@floridadm.org</a>.</p>
