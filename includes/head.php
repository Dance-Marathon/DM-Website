...
<html lang="en">
	<head>
        ...
        <!-- injector:css -->
        <link rel="stylesheet" href="/dist/1552584213013/css/DM-Website.min.css">
        <!-- endinjector -->
    ...
    <!-- injector:js -->
    <script src="/dist/1552584213013/js/DM-Website.min.js"></script>
    <!-- endinjector -->
	...
	<?php
	$dm_year = "2019";
	$dance_marathon_event_started = true;
	?>
