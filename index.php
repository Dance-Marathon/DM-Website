...
<!-- <div class="row">
  <div style="margin: 45px 0;">
      <div class="col-md-3">
        <div class="text-center">
          <h2 style="margin: 45px 0; font-weight: 400; text-transform: uppercase;"> <span style="font-size:0.75em;">Transform Today</br></span> <span style="color: #233563; font-weight: 700;">ORGANIZATION</br></span><span style="font-size:0.75em;">Leaderboard</span> </h2>
  ...
  <div style="margin: 45px 0;">
      <div class="col-md-3">
        <div class="text-center">
          <h2 style="margin: 45px 0; font-weight: 400; text-transform: uppercase;"> <span style="font-size:0.75em;">Transform Today</br></span> <span style="color: #e2883c; font-weight: 700;">DANCER</br></span><span style="font-size:0.75em;">Leaderboard</span> </h2>
  ...
  <div style="margin: 45px 0;">
      <div class="col-md-3">
        <div class="text-center">
          <h2 style="margin: 45px 0; font-weight: 400; text-transform: uppercase;"> <span style="font-size:0.75em;">Transform Today</br></span> <span style="color: #233563; font-weight: 700;">CAPTAIN</br></span><span style="font-size:0.75em;">Leaderboard</span> </h2>
  ...
  <div style="margin: 45px 0;">
      <div class="col-md-3">
        <div class="text-center">
          <h2 style="margin: 45px 0; font-weight: 400; text-transform: uppercase;"> <span style="font-size:0.75em;">Transform Today</br></span> <span style="color: #e2883c; font-weight: 700;">ELP</br></span><span style="font-size:0.75em;">Leaderboard</span> </h2>
...
<!--       <p><a class="btn btn-default huge-button" href="dm2015">Follow the event live here!</a></p> -->
      ...
      <!--<p style="margin:0"><a href="/dance-marathon" style="color:#e2883c"><b>Check out our 2018 Livestream</b></a></p>-->
...
<div id="event_banner">
    ...
    <p style="padding-top:0;"><i style="color:#233563;"><b>Dance Marathon</b></i> at the <i style="color:#233563;"><b>University of Florida</b></i> is gearing up for our 30th annual Main Event on April 13th-14th, 2024! Together, we continue our <i style="color:#e2883c;"><b>#FightForMore</b></i> for 26.2 hours in the Stephen C. O’Connell Center. We have so many things in store to celebrate our year long efforts including fan favorites such as the Linedance, Theme Hours, the Rave, talent performances, and so much more! Participants will have the opportunity to hear from our Miracle Families as they share their stories, and the impact that <i style="color:#233563;"><b>DM at UF</b></i> has had on their lives. Tune in to help us continue our fight against childhood illness and reach the day that no child has to wear a hospital band. 
    <p style="padding-top:0;"><i style="color:#233563;"><b>Dance Marathon</b></i> at the <i style="color:#233563;"><b>University of Florida</b></i> is the largest student-run and highest fundraising philanthropy in the Southeast United States. Our mission is to strive to bring together the campus and community to raise funds and awareness for our local Children's Miracle Network Hospital, <i style="color:#e2883c;"><b>UF Health Shands Children's Hospital</b></i>. We are going into our 30th year of <i style="color:#233563;"><b>Dance Marathon</b></i> at <i style="color:#233563;"><b>UF</b></i>, having fundraised over $30,000,000 thus far. This past year, we celebrated our 29th year by raising a historic <i style="color:#e2883c;"><b>$2,007,079.05</b></i>!
    <p style="padding-top:0;"><i style="color:#233563;"><b>30 years ago</b></i>, it was the resilience, the drive, the fight, in a group of students with a dedicated purpose, that has long since inspired thousands of members, partners, and donors to continue our battle. <i style="color:#e2883c;"><b>#FightForMore</b></i> encapsulates our determination to carry on the legacy of <i style="color:#233563;"><b>DM at UF</b></i> and all those who came before us. Our Miracle Children and Families are all fighting illnesses they did not choose to fight. They never stop fighting, so neither should we.  We all have the ability to fight; to create a world where children facing pediatric illness are not defined by their conditions, but rather their courage and determination to <i style="color:#e2883c;"><b>#FightForMore</b></i>.<br/>
  </b></a>
</i></p>
...
<div class="section">
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel" style = "width: 700px, margin: auto">
      ...
      <div class="carousel-inner">
            ...
            <?php
                $sponsor_imgs = range(2, 49); // the number of sponsor images we have in 2024 folder starting from 1 to 49. (1 is first active image)
                $i = 2;
      ...
      <a class="left carousel-control" href="#myCarousel" data-slide="prev" style="background: none; color: #233563;">
        <span class="glyphicon glyphicon-chevron-left"></span>
        <span class="sr-only">Previous</span>
         </a>
      <a class="right carousel-control" href="#myCarousel" data-slide="next" style="background: none; color: #e2883c">
