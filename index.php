...
<div id="event_banner">
    ...
    <p style="padding-top:0;"><i style="color:#e2883c;"><b>Dance Marathon</b></i> at the <i style="color:#e2883c;"><b>University of Florida</b></i> is the largest student-run and highest fundraising philanthropy in the Southeast United States. Our mission is to strive to bring together the campus and community to raise funds and awareness for our local Children's Miracle Network Hospital, <i style="color:#233563;"><b>UF Health Shands Children's Hospital</b></i>. We are going into our 30th year of <i style="color:#e2883c;"><b>Dance Marathon</b></i> at <i style="color:#e2883c;"><b>UF</b></i>, having fundraised over $30,000,000 thus far. This past year, we celebrated our 29th year by raising a historic <i style="color:#233563;"><b>$2,007,079.05</b></i>!
...
<div class="section">
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel" style = "width: 700px, margin: auto">
      ...
      <div class="carousel-inner">
            ...
            <?php
                $sponsor_imgs = range(2, 59); // the number of sponsor images we have in 2024 folder starting from 1 to 49. (1 is first active image)
                $i = 2;
