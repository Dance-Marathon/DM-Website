...
<div class="page-content">
	<div class="container">
      	<?php if ($status == "open") { ?>
			...
			<p><span style="color: #014083"><b>As we head into our</span> <span style="color: #F79B63">28th year</span><span style="color: #014083">, Dance Marathon at UF is excited to make even more miracles!</b></span></p>
				 <!-- Get updated numbers fro how many people visit UF Health-->
		<?php } else { echo 'This page is currently closed.'; } ?>
		</div>
	</div>
	<div class="check-out-buttons">
		<button class="check-out-button">CHECK OUT OUR BLOG</button>
		<button class="check-out-button">CHECK OUT OUR SPONSORS</button>
	</div>
	<div class="tab">
		...
		<button class="tablinks" onclick="openCity(event, 'meet-kids')">MEET THE KIDS</button>
	...
	<div id="faq" class="tabcontent faq">
		<?php if ($status == "open") { ?>
			...
			<p>Ranked one of the top 50 pediatric hospitals in the nation in seven categories, UF Health Shands Children’s Hospital and Children’s Miracle Network have created one of the greatest facilities of care for children and young adults.</p>
  			<p>For more information, please visit: <a href="https://ufhealth.org/shands-hospital-children-uf">https://ufhealth.org/shands-hospital-children-uf</a></p>
			<img src="/assets/images/TriBrandColors.png" alt="FT5K shirt" style="max-width:80%;max-height: 80%">
		  <?php } else { echo 'This page is currently closed.'; } ?>	</div>
</div>
