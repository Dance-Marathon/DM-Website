...
background-image: url("/assets/images/sectionbg/2021/Ambassadors.jpg");
}
</style>
...
<div class="page-content">
	<div class="container">
      ...
      <?php if ($status == "open") { ?>
		...
		<p>As we head into our 27th year, Dance Marathon at UF is excited to make even more miracles!</p>
