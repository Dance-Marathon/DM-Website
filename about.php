...
background-image: url("/assets/images/BannerPhotos21/about us.jpg");
}
</style>
...
<div class="page-content">
	<div class="container">
      ...
      <?php if ($status == "open") { ?>
		...
		<p>As we head into our 29th year, Dance Marathon at UF is excited to make even more miracles!</p>
