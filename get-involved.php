...
.subtab button.active {
    color: #CF1F41;
    border-bottom: 2px solid #CF1F41;
    height: 50px;
}
.zone {
    display: none;
                            ...
                            <div id="a1" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="q1">
                                <div class="panel-body">
                                    ...
                                    <p>If you would like to get involved with our organization, check out the list of positions below!</p>
                                           ...
                                           <ul><b style="color: #F27BAB">Organization:</b>     Student Organizations work year-round to support our cause.</ul>
                         <ul><b style="color: #F27BAB">Dancer:</b> Dancers stand on their feet if able for the duration of our Main Event in April to raise funds and awareness for UF Health Shands Children’s Hospital.</ul>
                                             <ul><b style="color: #F27BAB">Emerging Leader:</b> Members of our Emerging Leaders Program work alongside the Recruitment Team, providing support to Captain Teams and brainstorming new ideas to ensure a successful future for our organization.</ul>
                         <ul><b style="color: #F27BAB">Captain:</b> Captains belong to 1 of 15 teams and take on yearlong responsibilities specific to their respective teams, with the goal of supporting and promoting our organization.</ul>
                         <ul><b style="color: #F27BAB">Assistant Directors:</b> Individuals who work all year with their respective Overall Directors to ensure steady growth and management within their Captain Teams.</ul>
                         <ul><b style="color: #F27BAB">Overall Directors:</b> The 20 individuals who lead Dance Marathon efforts throughout the year. They are responsible for leading their respective Captain Teams to oversee, expand, and promote our organization.</ul>
...
<p>Dance Marathon at UF knows that the Gator Nation is everywhere. Formed in 2013, Dance Marathon at UF Alumni gives alumni across the country the opportunity to continue to give back and stay involved with their alma mater. Membership is only $40 per year and offers a variety of benefits.</p>
        ...
        <!--    <p>Within the Lifetime DMA Membership, there are <b><u>two</u></b> membership options:</p>
            <div></div>
          <h4><i style="color:#CF1F41;"><b>(1) Miracle Membership</b></i></h4>
        ...
        <h4><i style="color:#F27BAB;"><b>(2) Legacy Membership</b></i></h4>
            ...
            <p><b><i>Membership Benefits Include:</i></b></p>
                ...
                <p><b style="color:#CF1F41;">Event Package:</b></p>
                <ul>
                    ...
                    <p><b style="color:#CF1F41;">The Event Package includes:</b></p>
        ...
        <p>1. As a <b style="color:#CF1F41;">Miracle Member</b> of the DMA, you will have the benefit to maintain this status for life. You may elect to upgrade your membership to the new <b style="color:#F27BAB;">Legacy Membership</b> as outlined below.</p>
        <p>2. Any returning member, whose current membership lapses, will automatically move into the <b style="color:#CF1F41;">Miracle Membership</b> status. These members may upgrade to the new <b style="color:#F27BAB;">Legacy Membership</b> at any time throughout the year, up until one month before Dance Marathon weekend. </p>
-->
