      ...
      <?php if ($status == "open") { ?>
        <div role="tabpanel">
          ...
          <div class="tab-content">
            ...
            <p><object width="720" height="480" data="http://www.youtube.com/v/yeRQhLtFIuU" type="application/x-shockwave-flash"><param name="src" value="http://www.youtube.com/v/yeRQhLtFIuU" /></object></p>
            </br>
