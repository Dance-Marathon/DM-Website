...
<p>Dance Marathon at UF knows that the Gator Nation is everywhere. Formed in 2013, Dance Marathon at UF Alumni gives alumni across the country the opportunity to continue to give back and stay involved with their alma mater. Membership is only $40 per year and offers a variety of benefits.</p>
					...
					<!--	<p>Within the Lifetime DMA Membership, there are <b><u>two</u></b> membership options:</p>
						<div></div>
					  <h4><i style="color:#ffe249;"><b>(1) Miracle Membership</b></i></h4>
					...
					<h4><i style="color:#f3839c;"><b>(2) Legacy Membership</b></i></h4>
						...
						<p><b><i>Membership Benefits Include:</i></b></p>
							...
							<p><b style="color:#ffe249;">Event Package:</b></p>
							<ul>
                                ...
                                <p><b style="color:#ffe249;">The Event Package includes:</b></p>
					...
					<p>1. As a <b style="color:#ffe249;">Miracle Member</b> of the DMA, you will have the benefit to maintain this status for life. You may elect to upgrade your membership to the new <b style="color:#f3839c;">Legacy Membership</b> as outlined below.</p>
					<p>2. Any returning member, whose current membership lapses, will automatically move into the <b style="color:#ffe249;">Miracle Membership</b> status. These members may upgrade to the new <b style="color:#f3839c;">Legacy Membership</b> at any time throughout the year, up until one month before Dance Marathon weekend. </p>
-->
