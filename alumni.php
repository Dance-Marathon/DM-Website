...
a.       Seeing the LINEDANCE for the first time as a freshman and knowing I wanted to be one of those people dancing on stage in crazy costumes
    ...
    array(
      ...
      'continued'             =>  '<p>Literally every single moment of the 5 years I was involved, impossible to pick but here are some highlights:
...
</br>- Oh, and of course all of the total reveals - hello. Okay, I&#39;m done.</p>',
      'image'                 =>  'JoelleW'
    )
  );
?>
