...
<div class="page-content">
	<div class="container">
      ...
      <?php if ($status == "open") { ?>
					...
					<p>Applications are now open! Applications will be due <b>Friday, September 4th</b>.</p>
					...
					<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
						<div class="panel panel-default">
							...
							<div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
								...
								<p>As reflected on the application, <i>Entretainment</i> and <i>Productions</i> are no longer. We have redistributed responsibilities a new team: <b>Productions</b>.</p>
