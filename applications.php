<?php
	$status = "open";
	$GLOBALS['page_title'] = 'Applications | Get Involved | Florida Dance Marathon';
...
<p>
        ...
        <p>Please email our Membership Manager, Joey Whelihan, at <a href="mailto:jwhelihan@floridadm.org">jwhelihan@floridadm.org</a>,</p> if you have any additional questions!
      <?php } else { ?>
