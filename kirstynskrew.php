<?php
	$status = "open";
	$GLOBALS['page_title'] = 'Kirstyn\'s Krew | Get Involved | Dance Marathon at UF';
...
<div class="page-content">
	<div class="container">
      ...
      <?php if ($status == "open") { ?>
					...
					<li> Dance Marathon Closing Ceremonies on March 31 at 2:00 p.m. </li>
					</ul>
					<p> Additional optional events throughout the marathon include: </p>
					<ul>
					<li> Miracle Family meet and greet </li>
					...
					<p>Application <b>CLOSES:</b> April 5th 11:59 p.m.</p>
					<p>Applications for Kirstyn's Krew 2020 are now available <a href="https://events.dancemarathon.com/index.cfm?fuseaction=donorDrive.event&eventID=4571">here</a> through April 5th at 11:59pm!</p>
