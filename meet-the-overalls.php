          ...
          if(($i - 2) % 3 == 0) {
            echo '</div>';
				...
				<div>
					...
					<p>If you have Classy questions, or problems with a donation, please contact <a href="mailto:emcclane@floridadm.org ">emcclane@floridadm.org </a></p>
				</div>
