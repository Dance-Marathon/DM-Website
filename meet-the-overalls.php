<?php
  ...
  $overalls = array(
	  ...
	  'image'                 =>  'Blank',
		 ...
		 'free_time' => 'Free time? Never heard of it. In between all of my involvement on campus, I find time where I can to relax. I usually just hang out with my friends and either play basketball or watch Netflix shows! ',
	    ...
	    'previous_involvement'  =>  'Kappa Delta Sorority, Multimedia Captain, Multimedia Overall',
	  ...
	  array(
	   ...
	   array(
		...
		array(
	   'name' => 'Emily Podolsky',
	   'position' => 'Hospitality Overall',		   'email' => 'epodolsky@floridadm.org',
