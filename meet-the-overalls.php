        ...
        for($i = 0; $i < count($overalls); $i++) {
          ...
          <div class="col-sm-4">
            <a href="#" style="display: block;" class="text-center" data-toggle="modal" data-target="#myModal<?php echo $i; ?>">
              <img style="border: none;" class="img-circle img-thumbnail" src="<?php echo ('/assets/images/OT23 PreHeadshots/'.$overalls[$i]['image']); ?>" alt="..."><br>
